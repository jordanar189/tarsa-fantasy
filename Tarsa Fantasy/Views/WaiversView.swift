...
//
// Free-agent browsing/acquisition now lives entirely on the Players tab, where
// each player row shows an add / claim / trade / unavailable status icon.
struct WaiversView: View {
    ...
    @State private var subTab: SubTab = .waivers
